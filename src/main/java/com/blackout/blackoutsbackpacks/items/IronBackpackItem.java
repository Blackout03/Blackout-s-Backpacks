...
public class IronBackpackItem extends BackpackItem {
	...
	public ActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (!worldIn.isClientSide) {
			...
			NetworkHooks.openGui(serverPlayerEntity, new BackpackItemContainerProvider(handIn, playerIn.getItemInHand(handIn), 12, 2), (buf) -> buf.writeInt(handIn == Hand.MAIN_HAND ? 0 : 1));
